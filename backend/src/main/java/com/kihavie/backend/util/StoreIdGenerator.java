...
public class StoreIdGenerator implements IdentifierGenerator {

    private static final String PREFIX = "kih-shop-";

    @Override
    public Object generate(SharedSessionContractImplementor session, Object object) {
        String maxId = session
                .createNativeQuery("SELECT id FROM stores ORDER BY id DESC LIMIT 1", String.class)
